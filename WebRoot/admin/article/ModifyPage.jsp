 	       ...
 	       <form name="ArticleForm">
 				<div class="well well-lg"  >  
					 			<div class="form-group">
							      ...
							      <input  type="text" name="title" class="form-control" id="name"  value="${a.title}"
							         placeholder="请输入名称">
							   </div>
							    ...
							    <script type="text/javascript">
					 			...
					 			<div class="form-group">
							      ...
							      <input type="text" name="label" value="${a.type }" class="form-control" id="name" 
							         placeholder="请输入标签">
							    </div>
				 				  ...
				 				  <label class="checkbox-inline">
								      <input type="radio" name="open" id="optionsRadios3" 
								         value="1" <c:if test="${a.open==true}">checked=checked</c:if>	
								         
								         > 公开   </label>
								   <label class="checkbox-inline">
								      <input type="radio" name="open" id="optionsRadios4" 
								         value="0"
								         <c:if test="${a.open==false}">checked=checked</c:if>
								         > 个人  </label></>
				 				 <br> <br>
				 				 <div class="form-group">
						 ...
						 <ul class="nav nav-pills nav-stacked" style="margin-left: 6px">
    					<li class="active" style="text-align: center;"><a href="javascript:postForm()"><span class=" glyphicon glyphicon-save ">&nbsp;保存修改</span></a></li>
    					</ul>			
		 		</div>
