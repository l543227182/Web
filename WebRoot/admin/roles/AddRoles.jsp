...
<html>
   ...
   function validateForm(){
		...
		$form.attr("action","addRoles.do").attr("method","post").submit();
	}
</script>  
  </head>
          ...
          <table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="180" height="35" align="left" valign="middle">
                  <span class="table_k_bg1"> 
                  	<input type="text" name="NAME" maxlength="100" size="20" value="" />
                  </span>
                </td>
            ...
            <table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <c:forEach items="${p}" step="2"  var="per" varStatus="pp">
	              <tr> 
	              	<td width="100">&nbsp;</td>
	              	 <td align="left" valign="middle" width="30"> <input type="checkbox" name="addPermission" value="${per.value }"/> </td>
	                <td width="200" height="35" align="left"> ${per.name} </td>
	               
	                <td align="left" valign="middle" width="30"> <input type="checkbox" name="addPermission" value="${p[pp.index+1].value}"/> </td>
	                <td width="200" height="35" align="left">${p[pp.index+1].name}</td>               
           ...
           <table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="180" height="35" align="left" valign="middle">
                  <span class="table_k_bg1"> 
                  	<textarea name="REMARK" rows="8" cols="32" value="" onKeyPress="if (event.keyCode ==39||event.keyCode ==34) event.returnValue = false;"></textarea>
                  </span>
                </td>
